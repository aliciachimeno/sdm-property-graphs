...
write.csv(Edge_paper_volumes, "clean_datasets/Edge_paper_volumes.csv", row.names = FALSE) 
...
write.csv(Node_volume, "clean_datasets/Node_volumes.csv", row.names = FALSE) 
```
...
write.csv(Edge_paper_journal, "clean_datasets/Edge_paper_journal.csv", row.names = FALSE) 
```

Node_journals:
```{r}
Node_journals <- unique(Edge_paper_journal[,2])
write.csv(Node_journals, "clean_datasets/Node_journals.csv", row.names = FALSE) 
```
...
write.csv(Edge_edition_conference, "clean_datasets/Edge_edition_conference.csv", row.names = FALSE) 
```
...
```{r}
names(dblp_topics)
Edge_papers_keywords<-dblp_topics[,c(1,5)]
```

Node_keywords
```{r}
Node_keywords <- unique(Edge_papers_keywords[,4])
Node_keywords
